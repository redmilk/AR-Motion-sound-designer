...
protocol AlertPresentable: AnyObject {
    func displayAlert(fromParentView view: UIView, with text: String, title: String?, isDangerAction: Bool?,
...
extension AlertPresentable {
    ...
    @discardableResult
    func displayAlert(
        fromParentView view: UIView, with text: String, title: String?,  isDangerAction: Bool?,
        ...
        if let isDangerAction = isDangerAction, isDangerAction {
            alert.extraActionButton.isSelected = true
        }
